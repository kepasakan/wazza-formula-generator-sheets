...
export default function Sidebar({ role, name, email }: Props) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-green-950 flex flex-col h-full">
      {/* Logo */}
      <div className="px-6 py-5 border-b border-green-800/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-green-400 text-xs">Kolej Islam As-Sofa</p>
          </div>
        </div>
      </div>
      ...
      {/* User info + logout */}
      <div className="px-3 py-4 border-t border-green-800/50">
        <div className="px-3 py-3 rounded-lg bg-green-900/50 mb-3">
          <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-green-300 hover:bg-red-900/40 hover:text-red-300 transition-all"
        >
